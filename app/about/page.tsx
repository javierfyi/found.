          ...
          <div className="flex flex-col gap-12 max-w-7xl">
            ...
            <div className="max-w-7xl">
              <p
                ...
                style={{
                  fontFamily:
                    '"Neue Haas Grotesk Display Pro 65 Medium", "Neue Haas Grotesk Display Pro 65 Medium Placeholder", sans-serif',
                  fontSize: "16px",
                  fontWeight: 600,
                  letterSpacing: "0px",
                  lineHeight: "100%",
              ...
              >
                ...
                built with Motion and Tailwind CSS. Install any component into
                your project with a single{" "}
                <span style={{ color: "rgb(0, 0, 0)" }}>npx shadcn add</span>{" "}
                command. The source code is copied directly into your codebase —
                no runtime dependency on Foundry, no packages to keep in sync.
                Modify the components however you want.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col items-start leading-none gap-0">
                <a
                  ...
                  className="text-xs font-bold text-black transition-colors hover:text-black/70"
                >
                  hello@euler.fyi
                </a>
                <a
                  href="https://github.com/javierfyi"
                  className="-mt-0.5 text-xs font-bold text-black transition-colors hover:text-black/70"
                >
                  @javierfyi
                </a>
              </div>
