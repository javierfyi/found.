    ...
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      <footer className="flex w-full items-end gap-x-20 px-4 py-4 text-xs">
        ...
        <div className="flex flex-1 flex-col items-start leading-none gap-0">
          <a href="https://instagram.com/byeulerrr" target="_blank" rel="noopener" className="text-xs font-bold text-black/40 transition-colors hover:text-black">
            Instagram
          </a>
          <a href="https://linkedin.com/in/byeulerrr" target="_blank" rel="noopener" className="-mt-0.5 text-xs font-bold text-black/40 transition-colors hover:text-black">
            LinkedIn
          </a>
          <a href="https://pinterest.com/byeulerrr" target="_blank" rel="noopener" className="-mt-0.5 text-xs font-bold text-black/40 transition-colors hover:text-black">
            Pinterest
          </a>
        </div>
